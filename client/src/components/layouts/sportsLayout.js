        ...
        <Container>
            ...
            <div >
                <ButtonGroup className="mb-4" >
                    ...
                    {/* for not checklist just links to the google drive */}
                    <Button href={props.checklist} >Checklist</Button>
                    <DropdownButton as={ButtonGroup} title="Roster/Staffing" id="bg-nested-dropdown">
                        ...
                        <Dropdown.Item href={props.staffTrip} eventKey="2">IP Trip Staffing Spreadsheet</Dropdown.Item>
                    </DropdownButton>
                    <DropdownButton as={ButtonGroup} title="Documents" id="bg-nested-dropdown">
                        ...
                        <Dropdown.Item href={props.sportName + "/Curriculum"} eventKey="5">Curriculum Documents</Dropdown.Item>
                    ...
                    <DropdownButton as={ButtonGroup} title="Trip Info" id="bg-nested-dropdown">
                        <Dropdown.Item href={props.sportName + "/redbooks"} eventKey="8">Redbooks</Dropdown.Item>
